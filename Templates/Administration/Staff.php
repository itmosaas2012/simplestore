...
<form method="post" action="/Administration/AddUser">
    ...
    <div class="form-div">
        <label class="form-label" for="workPlace"> Место работы: </label>
        <input class="form-input" type="text" name="workPlace" id="workPlace" />
    </div>

    <div class="form-div">
        <label class="form-label" for="rank"> Должность: </label>
        <input class="form-input" type="text" name="rank" id="rank" />
    </div>
